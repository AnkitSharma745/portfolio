...
import { FaCode, FaLaptopCode, FaUserSecret, FaArrowLeft, FaDownload, FaBriefcase, FaProjectDiagram, FaTools } from "react-icons/fa";
            ...
            <main className="min-h-screen bg-background text-foreground relative overflow-hidden pt-24 pb-10">
                ...
                <div className="relative z-10 container mx-auto px-6">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-20">
                        ...
                        >
                            I&apos;m a passionate Full Stack Developer and Desktop App Specialist with a knack for building high-performance, scalable applications. My journey is defined by a relentless pursuit of code perfection and user-centric design.
                        </motion.p>
                    </div>
              ...
              `}
                        ...
                        <div className="max-w-3xl mx-auto space-y-6">
                            {skills.map((skill, index) => (
                                ...
                                >
                                    ...
                                    <div className={`h-3 rounded-full overflow-hidden ${isDark ? "bg-white/10" : "bg-black/5"}`}>
                                        <motion.div
                                            initial={{ width: 0 }}
                  ...
                  ${isDark ? "bg-white/5 border-white/10" : "bg-white border-black/5 shadow-md"}
                `}
                                >
                                    <div className="text-3xl text-accent mb-3 inline-block">
                                        <item.icon />
                                    </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            ...
                            <Link href="/projects">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className={`px-8 py-3 rounded-full font-medium transition-all border ${isDark

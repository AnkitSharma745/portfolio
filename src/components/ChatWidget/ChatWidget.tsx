...
import { JOURNEY_PHASES } from "@/content/hero/journey";
...
export default function ChatWidget() {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    if (
      ...
      (lowerText.includes("open") || lowerText.includes("go to"))
    ) {
      ...
      lowerText.includes("command palette") ||
      lowerText.includes("cmd+k")
    ) {
      openCommandPalette();
    ...
    if (!actionTaken) {
      if (lowerText.includes("experience") || lowerText.includes("how long")) {
        ...
        botResponse =
          "Ankit is a Full-Stack expert! 🛠️ Core stack: React, Next.js, Node.js, TypeScript. He also works with AWS, MongoDB, Redux, and modern UI libraries like Tailwind CSS and Framer Motion.";
      } else if (
        lowerText.includes("contact") ||
        ...
        botResponse =
          "You can reach Ankit at ankitaksharma9763@gmail.com. He's always open to interesting conversations and opportunities! 📧";
      } else if (
        lowerText.includes("available") ||
        lowerText.includes("hire")
      ) {
        botResponse =
          "Yes! Ankit is currently open to new opportunities and freelance projects. Let's build something amazing together. 🤝";
      } else if (
        ...
        botResponse =
          "Hello! 👋 I'm Ankit's AI Assistant. Feel free to ask me about his skills, projects, or experience!";
      } else {
        botResponse =
          "That's an interesting question! While I'm just a simulated AI, I'm still learning. Try asking about Ankit's projects, skills, or experience, or ask me to open his GitHub!";
      }
    }

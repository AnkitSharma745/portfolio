...
export default function Connect() {
    ...
    return (
        <section id="connect" className="py-20 px-6 md:px-16 relative overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-16">
              ...
              `}
                        >
                            <div className={`text-5xl mb-4 text-foreground/80 transition-colors duration-300 ${contact.color}`}>
                                {contact.icon}
                            </div>

                            <h3 className="text-xl font-bold mb-2">{contact.title}</h3>
                            <p className="text-sm text-foreground/60 mb-4">{contact.description}</p>

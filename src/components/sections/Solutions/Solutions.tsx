...
export default function Solutions() {
    ...
    return (
        <section id="solutions" className="py-20 px-6 md:px-16 relative overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                >
                    ...
                    <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
                        Custom tools and libraries I&apos;ve built to solve real-world problems and streamline development.
                    </p>
                </motion.div>

...
const ToolCategory = ({ title, tools, delay }: { title: string, tools: TechItem[], delay: number }) => {
        ...
        >
            ...
            `}
                    >
                        ...
                        <span className="text-sm font-medium text-foreground/70">{tool.label}</span>
                    </motion.div>
                ))}
            </div>
        </motion.div>
...
export default function Tools() {
    return (
        <section id="tools" className="py-20 px-6 md:px-16 relative overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                >
                    ...
                    <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
                        The software and hardware that power my development workflow and productivity.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-12">
                        <ToolCategory title="Productivity" tools={TOOLS_PRODUCTIVITY} delay={0.4} />
                        <ToolCategory title="Communication" tools={TOOLS_COMMUNICATION} delay={0.6} />
                    </div>
                </div>
            </div>

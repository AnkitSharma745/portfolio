        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mt-8">
            <motion.button
              ...
              className="px-8 py-4 rounded-full bg-gradient-to-r from-primary to-cyan-600 text-white font-bold text-lg shadow-lg shadow-primary/25 flex items-center justify-center gap-3 hover:shadow-2xl hover:shadow-primary/40 transition-all active:scale-95 group"
            >
              <FaPlay className="text-xl group-hover:scale-110 transition-transform" /> Watch Intro
            </motion.button>
